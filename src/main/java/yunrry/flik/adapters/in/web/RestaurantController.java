...
import yunrry.flik.adapters.in.dto.RestaurantSearchResponse;
...
public class RestaurantController {
    ...
    @GetMapping
    public ResponseEntity<Response<RestaurantSearchResponse>> searchRestaurants(
        ...
        RestaurantSearchResponse response = RestaurantSearchResponse.from(restaurants);
