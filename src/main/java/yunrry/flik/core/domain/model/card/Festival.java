...
public class Festival extends Spot {
    ...
    @Override
    public Festival withTags(String tag1, String tag2, String tag3, String tags) {
        return new Festival(
                ...
                this.eventStartDate, this.eventEndDate, this.ageLimit, this.sponsor, this.runningTime, this.fee
        );
    }
}
