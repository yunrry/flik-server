...
@Getter
public class Cultural extends Spot {

    private final String fee;

    public Cultural(Long id, String name, String contentTypeId, String contentId,String category, String description,
    ...
    @Override
    public Cultural withTags(String tag1, String tag2, String tag3, String tags) {
        return new Cultural(
                ...
                this.openTime, this.closeTime, this.time, this.dayOff, this.googleReviews, this.fee
        );
    }
}