...
public class Leisure extends Spot {
    ...
    public Leisure(Long id, String name, String contentTypeId, String contentId, String category, String description,
    ...
    @Override
    public Leisure withTags(String tag1, String tag2, String tag3, String tags) {
        return new Leisure(
