...
public class TourSpot extends Spot {
    ...
    public TourSpot(Long id, String name, String contentTypeId, String contentId, String category, String description,
    ...
    @Override
    public TourSpot withTags(String tag1, String tag2, String tag3, String tags) {
        return new TourSpot(
