...
class SportsRecreationMigrator:
    ...
    def get_sports_recreation_data(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.info(f"fetched_sports_recreation {len(data)}건 조회")
            return data
    ...
    def insert_into_spots(self, spots_data: List[Dict[str, Any]]) -> bool:
        ...
        try:
            ...
            INSERT INTO spots (
                ...
                review_count, signgu_cd, tag1, tag2, tag3, tags, label_depth1, label_depth2, label_depth3, time, reservation, exp_guide, google_reviews
            ) VALUES (
